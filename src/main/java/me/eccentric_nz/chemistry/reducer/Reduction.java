...
public enum Reduction {
    ...
    End_Stone(Material.END_STONE, "Silicon:59-Carbon:13-Unknown:11"),
    Glowstone(Material.GLASS, "Argon:20-Boron:20-Krypton:20-Neon:20-Unknown:20"),
    ...
    Redstone(Material.REDSTONE, "Carbon:31-Uranium:31-Unknown:38"),
